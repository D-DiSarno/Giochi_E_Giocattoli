...
public class Paginator {
    ...
    public Paginator(int page,String servlet){
        int itemsPerPage=0;
        if(servlet.compareToIgnoreCase("ProdottoServlet")==0){
            itemsPerPage=20;
        }
        if(servlet.compareToIgnoreCase("ClienteServlet")==0){
            itemsPerPage=20;
        }
        if(servlet.compareToIgnoreCase("CategoriaServlet")==0){
            itemsPerPage=30;
        }
        if(servlet.compareToIgnoreCase("OrdineServlet")==0){
            itemsPerPage=30;
        }
        if(servlet.compareToIgnoreCase("ProduttoreServlet")==0){
            itemsPerPage=20;
        }
