...
<form method="post" action="../accounts/create" id="crmForm">

    <fieldset class="grid-x form admin">
        <legend>Crea Cliente</legend>
        <label for="Nome" >
        ...
        <label for="Mail" >
            <input id="Mail" name="Mail" placeholder="e-mail" type="text" value="${cliente.email}" required>
        </label>
        <label for="password" >
            <input id="password" name="password" placeholder="password" type="password" value="${cliente.password}" required>
        </label>
